...
- 绑定生命周期系列已实施前两张票据并发布 v2.1.0（2026-09-14，机器审查通过、待用户人工验收）：remote_help 按需指引（#30，PR #34）与 configure 停止落盘加三代迁移清理（#31，PR #35）；绑定移除（#32）与 CLI 收尾（#33）已在 PR #36 完成实施、待审查合入，票据见 `docs/design/binding-lifecycle-tickets.md`。
