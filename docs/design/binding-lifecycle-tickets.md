...
状态：2026-09-14 拆票完成，#30–#33 共 4 张票据，已全部实施。#30 已实施（PR #34）；#31 已实施（PR #35，随 v2.1.0 发布）；#32–#33 已实施（PR #36，三轮审查通过后合入，随 v2.2.0 发布——机器审查通过、待用户人工验收）。实施顺序为线性链：#30 → #31 → #32 → #33。
...
规格：#28（八项决策见其评论）。已实施（PR #36，随 v2.2.0 发布）。
...
规格：#28。已实施（PR #36，随 v2.2.0 发布；含两项记档项：CONTEXT.md 大文件访谈节时点更正、test/README.md 测试树补齐）。
