...
export async function runWorkspaceServer(profile: string): Promise<void> {
  ...
  register("remote_edit", "Apply unique exact replacements only inside previously read ranges. Reject stale versions; preserve BOM, permissions and existing CRLF convention.",
